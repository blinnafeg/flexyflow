...
<template>
  <div class="space-y-4">
    <!-- Превью + выбор -->
    <div class="space-y-2">
      <Label class="text-xs text-muted-foreground">Выбранная иконка</Label>
    ...
    <!-- Размер -->
    <div class="space-y-1">
      <Label class="text-xs text-muted-foreground">Размер (px)</Label>
      <Input
        type="number"
    ...
    <!-- Толщина линий -->
    <div class="space-y-1">
      <Label class="text-xs text-muted-foreground">Толщина линий</Label>
      <Input
        type="number"
    ...
    <!-- Цвет иконки -->
    <div class="space-y-1">
      <Label class="text-xs text-muted-foreground">Цвет иконки</Label>
      <ColorPickerInput
